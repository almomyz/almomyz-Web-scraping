...
import auth from "../output/config";

// local uri
const localUri = 'mongodb://localhost:27017';

// for remote uri provide your it here
const uri = 'mongodb+srv://heshammohammed890:heshammohammed890@myatlasclusteredu.tizay0s.mongodb.net/?retryWrites=true&w=majority&appName=myAtlasClusterEDU'
